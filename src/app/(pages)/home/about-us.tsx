    ...
    <section className={cn(fraunces.variable, "py-20 px-8 sm:px-14")}>
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-16 md:grid-cols-2">
        ...
        <div className="relative">
          ...
          <div className="absolute md:-bottom-8 -bottom-4 md:-left-8 -left-4 flex h-32 w-32 flex-col items-center justify-center rounded-xl bg-[#D4A24C] text-center shadow-lg sm:h-36 sm:w-36">
